                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" id="form" action="{{ '/post_edit_product/'.$product->id}}" method="post" >
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input name="price" class="form-control" value="{{$product->price}}"  required></input>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <textarea name="description" type="text" class="form-control" rows="10" required>{{$product->description}}
                                            </textarea>
                                        </div>
                                        ...
                                        <div class="col-12 ">
                                            <div class="">
                                                <button style="display: block;margin-right:auto;margin-right:auto;" class="btn btn-success" type="submit">Update Product</button>
                                            </div>
